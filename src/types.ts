...
export interface Exercise {
  ...
  hint?: string;
  difficulty?: 'easy' | 'medium' | 'hard'; // AI-determined difficulty
  skillTags?: string[]; // e.g., ['vocabulary', 'grammar', 'listening']
}
...
// AI-Powered Learning Types
export type SkillCategory = 'vocabulary' | 'grammar' | 'listening' | 'speaking' | 'comprehension';
...
export interface SkillProficiency {
  ...
  weakTopics: string[]; // topics needing focus
}
...
export interface UserLearningProfile {
  ...
  lastAnalyzedDate: string; // ISO datetime
  recommendedNextLessons: string[]; // lesson IDs
  recommendedDifficulty: 'easy' | 'medium' | 'hard';
  learningPace: 'slow' | 'normal' | 'fast'; // determined by speed of completion
  consistencyScore: number; // 0-100, based on streak and frequency
  focusAreas: SkillCategory[]; // which skills need most focus
}
...
export interface AdaptiveLearningSession {
  ...
  exercises: {
    exerciseId: string;
    recommended: boolean;
    aiGenerated: boolean; // if true, generated by AI based on needs
  }[];
  performanceMetrics: Record<string, number>; // flexible metrics
}
...
export interface UserState {
  ...
  // AI-Powered Learning additions
  learningProfile?: UserLearningProfile;
  exercisePerformanceHistory?: ExercisePerformance[];
  adaptiveSessionHistory?: AdaptiveLearningSession[];
}
